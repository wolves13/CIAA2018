...
When two beads form an h-interaction, informally we say they are bound. 
...
\foreach \x in {0} {
\draw (\x, 0)++(120:1.5) -- node[below] {Seed} ++(0:1) -- ++(300:0.5) -- ++(180:0.5) node (seedout) {} -- ++(180:0.5) -- cycle;
}

\foreach \x in {0} {
\draw (\x, 0) -- ++(0:0.5) node (C1in) {} -- ++(0:0.5) -- ++(300:2) -- ++(180:1) -- cycle; 
\draw[white] (\x+0.5, 0) -- node[sloped, black] {Counter $C$} ++(300:2) node (C1out) {};
}

\foreach \x in {0} {
\draw (\x, 0)++(300:3) -- ++(0:0.5) node (Dvin) {} -- ++(0:0.5) -- ++(300:0.5) -- ++(180:0.5) node (Dvout) {} -- ++(180:0.5) -- cycle; 
\draw[white] (\x, 0)++(300:3.25) -- node[black] {$D_v$} ++(0:1);
}

\foreach \x in {7} {
%\draw (\x, 0) -- ++(0:0.8) -- ++(300:0.8) -- ++(180:0.8) -- cycle;
\draw[thick, ->] (\x, 0) node (O1in) {} -- ++(0:0.8) -- ++(300:0.1) -- ++(180:0.8) -- ++(300:0.1)
...
\foreach \x in {5} {
%\draw (\x, 0) -- ++(0:0.8) -- ++(300:0.8) -- ++(180:0.8) -- cycle;
\draw[thick, ->] (\x, 0) node (A1in) {} -- ++(0:0.8) -- ++(300:0.1) -- ++(180:0.8) -- ++(300:0.1)
-- ++(0:0.8) -- ++(300:0.1) -- ++(180:0.8) -- ++(300:0.1)
-- ++(0:0.8) -- ++(300:0.1) -- ++(180:0.8) -- ++(300:0.1)
-- ++(0:0.8) -- ++(300:0.1) -- ++(180:0.8) -- ++(300:0.1)
-- ++(0:0.8) -- ++(300:0.1) -- ++(180:1)
...
\draw[-latex] (seedout) -- node[right] {No carry} (C1in);
\draw[-latex] (C1out) -- (Dvin);
\draw(A1in)++(180:0.25)++(120:1) node[circle, draw, inner sep=0in] (AO1in) {};
\draw (Dvout) to [out=300, in=180] (AO1in);
\draw[-latex] (AO1in) to [out=0, in=120] node[below] {A} (A1in);
\draw[-latex] (AO1in) to [out=0, in=120] node[above] {O} (O1in);
