...
\caption{The two bricks of \texttt{PFS} above and the corresponding two bricks of (left) $\mathtt{AO}_v$ and (right) $\mathtt{AO}_h$.}
\label{fig:PFS}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\linewidth]{Figs/body-lgy}
