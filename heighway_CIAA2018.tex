...
The $n$ half-adders and the spacers between them fold into a zig ($\leftarrow$), the left-turner reverses the folding direction, the $n$ formatters and the spacers between them fold into a zag ($\rightarrow$), and the right-turner reverses the folding direction back for the next zigzag folded by the next period. 
