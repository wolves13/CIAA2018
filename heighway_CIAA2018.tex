...
Since \texttt{Left-turner} always ends at the top and spaces always start and end at the top, \texttt{Formatter} never encounters any other environment (see the brick automaton in Fig.~\ref{fig:BA_counter_zag}). 
