...
It suffices to observe that neither $w[4]$ nor $w[5]$ can bind. 
...
The bit-bifurcator bifurcates the current count $i = a_n a_{n-1} \cdots a_1$ as well as the AO signal into the left and right using 10 submodules T-A, T-B, \dots, T-I, as illustrated in Fig.~\ref{fig:turner}.  
