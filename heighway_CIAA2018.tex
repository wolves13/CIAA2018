...
The first and second halves are diverted to implement the \texttt{body-rgy} and \texttt{body-gx} submodules of the turner module, respectively.}
\label{fig:Dzag2}
\end{figure}
...
All the bricks of the submodules of turner module omitted in the main text are shown in Figs.~\ref{fig:body-lgy}, \ref{fig:turn-lgp}. 

\begin{figure}[h]
\centering
\includegraphics[width=0.7\linewidth]{Figs/body-lgy}
\caption{The two bricks of \texttt{body-lgy} submodule}
\label{fig:body-lgy}
\end{figure}
...
\caption{The two bricks of \texttt{turn-lgp} submodule}
\label{fig:turn-lgp}
\end{figure}
