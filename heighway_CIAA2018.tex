...
\draw (10.5, 0) ++(300:4.75) node (AO1out) {($i$, carry) in \eqref{eq:turner_output}};
...
\end{tikzpicture}
\caption{Module automaton of the proposed cyclic DOS for the Heighway dragon $P[j_1 .. j_2]$. 
